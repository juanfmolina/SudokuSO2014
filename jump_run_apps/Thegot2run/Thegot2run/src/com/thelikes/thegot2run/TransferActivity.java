...
public class TransferActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Parse.initialize(this, "YqFw4gRsRwBlvL9UeN2hPkTZ0V1MHid1ptSVJbHY",
				"L85qVmSj5aQAQeyVKXI4CRHMUfPbhPcJe1x1v1pu");
	...
	public void onClick(View view) {
		...
		if (inspectConection(actividad)) {
			...
			Puntuacion puntaje = new Puntuacion(campoNombre.getText()
					.toString(), scoreJuego, fecha);
			...
			showAlertMessage("Se ha ingresado Correctamente el puntaje",
					"puntaje Ingresado");
			Obtener o = new Obtener();
			o.execute();
		} else {
			showAlertMessage(
					"Se Necesita Conexion a Internet Para Realizar Esta Accion",
	...
	public void enviarResultados(List<Puntuacion> puntajes) {
		intento = new Intent(this,ScoresActivity.class);
		Bundle b = new Bundle();
